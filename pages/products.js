        ...
        <div className="w-full">
          <div className="bg-white">
            <div className="">
                          ...
                          >
                            <li>
                              <button
                                ...
                                className="transition-all  px-4 py-2 hover:text-yellow-300"
                                type="button"
                              >
                                ALL PRODUCTS
                              </button>
              ...
              <main className="w-full px-6 lg:px-12">
                <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
                  <h2 className="text-4xl hidden lg:block sm:hidden font-bold tracking-tight text-gray-900">
                    Our Products
                  </h2>
                  <input
                    type="text"
                ...
                >
                  ...
                  <div className="grid   grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                    ...
                    <div className="lg:col-span-3">
                      {" "}
                      <div className="mx-auto py-16 sm:py-0  lg:px-8">
